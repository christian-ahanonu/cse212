...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The expected ouput did not match the actual output. Sue is dequeued instead of Bob 
    ...
    // Defect(s) Found: After adding George, Sue is dequeued instead of Tim
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Infinite turns is not working right. The first dequeued is Sue instead of Bob
    ...
    // Defect(s) Found: Negative turns is not handled as infinite. First person dequeued is Sue instead of Tim
